...
# Set up logging
logging.basicConfig(filename='scraping3.log', level=logging.ERROR, format='%(asctime)s %(levelname)s:%(message)s')
...
with open('animeDB4.csv', 'a+', newline='') as csvfile:
    ...
    for line in csvfile:
        cnt += 1
    print(cnt)
    for i in range(cnt-1+15001, 20001, 50):
