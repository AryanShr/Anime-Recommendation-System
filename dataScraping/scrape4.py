...
# Set up logging
logging.basicConfig(filename='scraping4.log', level=logging.ERROR, format='%(asctime)s %(levelname)s:%(message)s')
...
with open('animeDB5.csv', 'a+', newline='') as csvfile:
    ...
    for line in csvfile:
        cnt += 1
    print(cnt)
    for i in range(cnt-1+20501, 24451, 50):
