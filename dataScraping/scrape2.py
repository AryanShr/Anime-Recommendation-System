...
# Set up logging
logging.basicConfig(filename='scraping2.log', level=logging.ERROR, format='%(asctime)s %(levelname)s:%(message)s')
...
with open('animeDB3.csv', 'a+', newline='') as csvfile:
